        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.updateComponent',$id) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name[{{ $lan->code }}]" type="text"
                                                               class="form-control"
                                                               required=""
                                                               value="{{ $serviceComponent->translate($lan->code)->name ?? '-' }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(file_exists($serviceComponent->photo))
                                                <img src="{{ asset($serviceComponent->photo) }}" class="form-control">
                                            @endif
                                        </div>
                                    </div>
                                </div>
