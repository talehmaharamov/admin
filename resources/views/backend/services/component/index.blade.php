                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.services'): {{ \App\Models\Backend\Service::find($id)->translate('az')->name ?? '-' }}</h4>
                                <a href="{{ route('backend.serviceCreateComponent',$id)}}" class="btn btn-primary mb-3"><i
                                        class="fas fa-plus"></i>
                        ...
                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($components as $component)
                                <tr>
                                    ...
                                    <td class="text-center"><img src="{{ asset($component->photo) }}" width="100" height="50">
                                    <td class="text-center">{{ $component->name }}</td>
                                    <td class="text-center">
                                        <a class="btn btn-primary"
                                           href={{ route('backend.editComponent',['id'=>$component->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.deleteComponent',['id'=>$component->id]) }}">
